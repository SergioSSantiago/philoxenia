...
| `pricePerNight` | DAI list price; nights can override per day on the calendar. Place detail: **DAI list price** (not “Default list price”). Guests choose **STRK** (live FX) or **DAI** (1:1) at pay time — listing detail copy says both |
