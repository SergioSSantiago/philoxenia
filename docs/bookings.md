...
`/bookings/new` calendar copy: tap nights one by one; they need not be consecutive; then **Book & pay** in STRK or DAI. Empty selection: **Tap nights to Book & pay.** No open nights: ask the host to open nights you can **Book & pay**. Unauthorized place: **This place isn’t available to Book & pay.** Quote labels **Book & pay with** (STRK or DAI) and **Book & pay now**. Primary button is **Book & pay {amount} STRK/DAI**; busy: **Book & pay…** or **Private Book & pay…**; idle Private suffix is **· Private**. Guest calendar: past nights cannot be added to Book & pay. Own place: **You cannot Book & pay your own place.** **Back to place.** Missing query: **Missing place.** If the JWT is live but the wallet is not, the page asks to **Connect Ready X** (Chrome or iPhone) to **Book & pay** — Public and Private both need a live session; Private also needs wallet API ≥ 0.10. Reconnect failures and Private Book & pay errors name Ready X (not a generic Ready extension). Recording copy: do not tap **Book & pay** again — open My bookings. There is no silent fallback to Public Book & pay.
