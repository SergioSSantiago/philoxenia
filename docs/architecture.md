...
| Route | Purpose |
|-------|---------|
| `/` | Landing. Brand-first hero + live network stats; header brand links here. Guest card: **Book & pay through friendship or a place invite** (not “an invite”). Role heading **Earn as a connector** (not “Connector”) |
| `/home` | Unsigned heading **Book & pay with people you trust**; **Connect Ready X to Book & pay places from people you trust.** Signed-in: **Places from people you trust. Book & pay STRK or DAI.** Compact **Ready X wallet** + STRK/DAI + **Shield & swap** to Profile, globe of accessible places (pin **View place: {title}**, not “Open {title}”), friends’ places, **Shared with me** (**Place invites to Book & pay — last place invite wins connector attribution**; empty **No place invites yet**), own places (**share a place invite and earn**), **My stays** (recent Book & pay stays), friends count |
