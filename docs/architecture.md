...
| `/home` | Unsigned heading **Book & pay with people you trust**; **Connect Ready X to Book & pay places from people you trust.** Signed-in: **Places from people you trust. Book & pay STRK or DAI.** Compact **Ready X wallet** + STRK/DAI + **Shield & swap** to Profile, globe of accessible places (pin **View place: {title}**, not “Open {title}”), friends’ places, **Shared with me** (**Place invites to Book & pay — last place invite wins connector attribution**; empty **No place invites yet**), own places (**share a place invite and earn**), **My stays** (recent Book & pay stays), **Friends to Book & pay** (not “My friends”; pending **friend request(s) to Book & pay**) |
...
| `/friends` | Friends; search by **Ready X wallet**; tap name/wallet → friend places. Add heading **Add by Ready X wallet** (not “Add someone you trust”). Result CTA **Add by Ready X wallet** (not “Add friend”). Dismiss **Close add by Ready X wallet**. Sent: **Friend request sent — Book & pay after they accept.** Accept busy **Accepting…** (not “Working…”). Loader **Loading friends to Book & pay…**. Incoming **Friend requests to Book & pay** (not “Incoming requests”). Sent **Sent requests to Book & pay**. List **Friends to Book & pay** (not “Your friends”) |
