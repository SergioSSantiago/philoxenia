...
| `GET /stats/network` | Landing totals: **Ready X wallets** (not “users”), countries, **places to Book & pay**, **Book & pay nights** (not “paid nights”), DAI/STRK paid |
