...
| `/friends/[id]` | Friend profile: **Places to Book & pay** + share-as-connector. Back **Back to Friends to Book & pay** / **← Friends to Book & pay** (not “Back to friends”). Load fail **Could not load places to Book & pay** (not “this friend’s places”). Empty: **hasn’t published a place yet**; Book & pay when they **publish a place** |
