...
| Route | Purpose |
|-------|---------|
| `/` | Landing. Brand-first hero + live network stats; header brand links here. Intro **Book & pay with people you trust on Starknet** (not “private hospitality on Starknet”). `ReadyWalletNotice`: **Desktop:** Chrome with the Ready X wallet extension is recommended. **Phone:** Download the Ready X wallet app and open Philoxenia in the Ready X browser (not Desktop/iPhone/Firefox + Smart Wallet). Guest card: **Book & pay through friendship or a place invite** (not “an invite”). Role headings **Publish places** / **Earn as a connector** / **Book & pay** (not “Host” / “Connector” / “Guest”). Connector body **Share a friend’s place invite** (not “Introduce someone you trust”). Connector body **Earn the connector % set on the place** (not “host-set %”) |
| `/home` | Unsigned heading **Book & pay with people you trust**; **Connect Ready X to Book & pay places from people you trust.** Signed-in: **Places from friends to Book & pay. STRK or DAI.** (not “Places from people you trust”). Compact **Ready X wallet** + STRK/DAI + **Shield & swap** / **Edit Ready X** (not “Edit profile”) to Ready X; balances crash **open Shield & swap on Ready X** (not “try Shield & swap”), globe of accessible places (pin **View place: {title}**, not “Open {title}”; zoom **Zoom places in** / **Zoom places out** / **Reset globe of places**; empty globe **Add by Ready X wallet or publish a place** (not “Add friends by Ready X wallet”)), friends’ places (**Places from friends to Book & pay**, not “Places from my friends”; subtitle **Places from friends to Book & pay — STRK or DAI**, not “trust network”; empty **Add by Ready X wallet on Friends** (not “Add someone by Ready X wallet”)), **Place invites to Book & pay** (not “Shared with me”; subtitle **Last place invite wins connector % of stay**, not “connector attribution”; empty **No place invites yet**), own places (**Priced in DAI. Book & pay STRK or DAI**, not “Guests Book & pay”; **share a place invite and earn**), **My stays** (recent Book & pay stays), **Friends to Book & pay** (not “My friends”; pending **friend request(s) to Book & pay**; count **{n} friends to Book & pay**, not “{n} friends”; empty **Add by Ready X wallet** (not “Add people you trust”); CTA **Friends to Book & pay**, not “Manage friends”) |
| `/auth` | Legacy redirect to `/home` |
| `/profile` | Page title **Ready X** (not “Profile”). Display name, public STRK/DAI, shield/unshield **STRK or DAI**, shield checklist **Then enable Private in Ready X** (not “Enable Smart Wallet and Private”), public **swap STRK ↔ DAI** (subtitle **swap STRK ↔ DAI is public**, not “swap is public AVNU”). Disconnected swap helper **Connect Ready X to swap STRK ↔ DAI** (not “quote and swap”). Connected notice **You can swap STRK ↔ DAI now** (not “quote and swap”). Name field placeholder **Display name**; label **Display name (friends add you by Ready X wallet)** (not “Name shown to others”); CTA **Save display name** (busy **Saving display name…**; done **Display name saved**, not “Saved!”). Disconnect heading **Ready X in this browser** (not “Session”). Empty PATCH: **Enter a display name or sealed Messages keys**. Loader **Loading Ready X…** (not “Loading Ready X profile…”). Swap fail **Could not swap STRK or DAI**. Copy fail **Could not copy this Ready X wallet**. Helper **friends can add you** (not “trusted friends”). Helper body **Friends add you by Ready X wallet — display names are not searchable** (not “Change it anytime”) |
| `/friends` | Page title **Friends to Book & pay** (not “Friends”; nav stays **Friends**). Search by **Ready X wallet**; tap name/wallet → friend places. Add heading **Add by Ready X wallet** (not “Add someone you trust”). Result CTA **Add by Ready X wallet** (not “Add friend”). Idle CTA **Add by Ready X wallet** (not “Add friend by Ready X wallet”). Wallet card **Friends add you by Ready X wallet** (not “Share this so friends can add you”). Search **Search Ready X wallet** (not “Search”). Search-hit already friends **Already friends to Book & pay** (not “Already friends”); search-hit pending **Friend request sent** (not “Request pending”). Search-hit cancel **Cancel friend request to Book & pay** (not “Cancel friend request”); search-hit reject **Reject to Book & pay** (not “Reject”). Dismiss **Close add by Ready X wallet**. Sent: **Friend request sent — Book & pay after they accept.** Send busy **Sending friend request…**. Send fail **Could not send friend request to Book & pay**. Accept/reject fail **Could not update this friend request to Book & pay** (not “Could not update Friends to Book & pay”). Accept idle **Accept to Book & pay**; busy **Accepting…** (not “Working…”). Reject **Reject to Book & pay**. Cancel **Cancel friend request to Book & pay**. Cancel busy **Cancelling friend request…** (not “Cancelling…”). Loader **Loading friends to Book & pay…**. Load fail **Could not load friends to Book & pay**. Incoming **Friend requests to Book & pay** (not “Incoming requests”). Sent **Sent requests to Book & pay**. List **Friends to Book & pay** (not “Your friends”). Empty **Add by Ready X wallet (0x optional)** (not “Add someone by Ready X wallet”). List CTA **Messages** (not Message). End **End friendship** (not “Remove friend”). Success **Friendship ended** (not “Friend removed”). List subtitle **End friendship ends it for both of you** (not “Remove ends the friendship”) |
| `/friends/[id]` | Friend profile: **Places to Book & pay** + share-as-connector. Back **Back to Friends to Book & pay** / **← Friends to Book & pay** (not “Back to friends”). Load fail **Could not load places to Book & pay** (not “this friend’s places”). Empty: **They haven’t published a place yet** (not “This friend hasn’t”); Book & pay when they **publish a place** |
| `/messages`, `/messages/[friendId]` | Sealed chat + peer pay; banner **Sealed Messages is on**. Opening **Opening sealed Messages…**. Header **Sealed Messages** / **Waiting for friend’s sealed key**. Thread wallet title **Places to Book & pay for {name}** (not “{name}’s places”). Inbox lock **Sealed note**. Name/wallet → friend places; intro **share a place invite**; preview **Open Messages with …** (not “Open chat”). Empty-thread preview **Start a sealed note to Book & pay**. Empty thread heading **Start a sealed note to Book & pay** (not “Say hello — sealed note”). Inbox date **Yesterday in Messages** (not “Yesterday”). Empty inbox **Add by Ready X wallet on Friends** (not “Add someone by Ready X wallet”). Inbox load fail **Could not load sealed Messages.** (not “Could not load Messages.”). Keys fail **Could not enable sealed Messages**. Load fail **This Messages thread isn’t available.** Note fail **Could not send this sealed note**. Composer **Write a sealed note to Book & pay** / **Send sealed note** (not “Write a sealed note…” / “Send”). Pay fail **Could not send STRK or DAI**. Public send helper **Send STRK or DAI on-chain via Ready X**. Private send helper **From your shielded STRK or DAI via STRK20 on Ready X** (not “Ready X · Smart Wallet + Private”). Public send **Visible on Voyager** (not “explorers”). Missing tx **Send STRK or DAI needs a transaction hash.** Generic API miss **Could not reach Philoxenia. Try Philoxenia again.** Optional **Anchor this sealed note**. Pay sheet toggle **Close Send STRK or DAI** (not “Close”). Decrypt miss **Could not open this sealed note on this device**. Transfer eyebrow **Private Send STRK or DAI** (not “Private transfer”). Transfer body **Sent STRK or DAI** / **Received STRK or DAI** (not “You sent”). Tx link **View on Voyager** (not “View transaction”). Keys: **Ready X is required for sealed Messages** |
| `/my-listings`, `/listings/new` | **My places** subtitle **Priced in DAI. Book & pay STRK or DAI** (not “Private places priced in DAI”). Host place CRUD + map + availability calendar; headings **About this place** / **Open nights to Book & pay** (not “Open nights guests can Book & pay”); host range CTA **Open nights to Book & pay** (not “Add range”); start **Open from**; end date **Until (morning they leave)** (not “Until (morning guests leave)”); price **DAI list price / night**; create form labels **Title for this place** / **Description for this place**; create form label **DAI list price / night** (not “Default price per night (DAI)”); create form **Connector % of stay** (not “Connector reward (%)”); helper when someone **Book & pay through that place invite** (not “when they Book & pay in STRK or DAI”); submit busy **Publishing this place…**; idle **Publish this place** (not “List this place”); default cancel **paid who publishes this place (and connector)** (not “paid the host”); helper **who publishes this place and the connector already have the funds** (not “host and connector”); fail **Could not publish this place**; map heading **Place on the map**; search **Search this place** (not “Search”); missing pin **Pin this place on the map**; map coords **Pin a valid place on the map**; stay limits **Stay limits must allow at least one night to Book & pay**; default DAI **Enter a valid DAI list price / night**; night price **Enter a valid DAI list price for {day}** |
| `/listings/[id]` | Place detail (authorized viewers) + share; guest CTA **Book & pay**. Friend + % > 0 **Share place invite & earn**. Share busy **Creating place invite…**; fail **Could not share this place**. Copy **Copy place invite** (flash **Place invite copied**, not “Copied!”); status **Place invite copied** / **Place invite shared**. Native share button **Share place invite…** (not “Share via…”); native share text: **open this place invite**. Host share: **You published this place** — **this place invite has no connector** (not “You shared as the host” / “this link”); **do not create a connector % of stay** (not “connector reward”). Connector helper: friends with **who publishes this place** and Book & pay (not “the host”). Guest nights helper **selected — Book & pay** (not “continue to Book & pay”). Host nights busy **Saving open nights…** (fail **Could not save open nights**; discard **Discard open nights**). Delete fail **Could not delete this place**. Delete body **This permanently deletes this place** (not “removes the place”). Delete busy **Deleting this place…** (not “Working…”). Host badge **Publishes this place** (not “Host”; own place **Your place**). Map **Open this place on OpenStreetMap** (not “Open on OpenStreetMap”). Price helper **to who publishes this place & connector** (not “to host & connector”). Own place **You published this place — Book & pay is disabled here** (not “disabled for the host”). Unauthorized **This place isn’t available to Book & pay.** |
| `/invite/[token]` | Place invite landing; first paint **Opening place invite to Book & pay…**; missing/expired **This place invite isn’t available to Book & pay.** (not “Invitation unavailable.”). Request CTA **Request friendship to Book & pay with {name}** (not “Request friendship with”). Invite body **Place hosted by** (not “Private place hosted by”). Friends with **who publishes this place** (not “the host”). Host badge **Publishes this place** (not “Host”). Connector badge **Earns as connector** (not “Connector (Ready X payout)”). Pending **Friend request sent** (not “Friendship request sent”). Connector empty **None — they published this place invite** (not “None — host place invite”). Host share **This place invite has no connector reward.** (not “This host place invite”) |
| `/bookings`, `/bookings/new`, `/bookings/[id]` | Book & pay nights (**nights not consecutive** is fine, not “they need not be consecutive”); STRK or DAI. Empty nights **Ask them to open nights to Book & pay**. Public helper **Visible on Voyager**. DAI helper **Who publishes this place and the connector are paid immediately** (not “Host and connector”). Missing wallet **this place has no Ready X wallet** (not “this host”). Own place **You published this place — Book & pay is disabled here** (not “You cannot Book & pay your own place”). Own-place CTA **Back to this place** (not “Back to place”). Quote heading **Book & pay breakdown**; quote DAI row **Place list total (DAI)**. List title **My stays**. Stay status **Book & pay complete** / **Nights freed** / **Book & pay refunded** / **Recording Book & pay…** (not “Recording stay…”). Stay detail **Loading this Book & pay…** (not “Loading stay…”); missing **This stay isn’t available to Book & pay.** (not “Booking not found”). Missing place title **this place** (not “Private place”). Night labels **First night** / **Morning you leave** (not Check-in / Check-out). Gapped nights **nights not consecutive** (**First night / Morning you leave is the bounding window**). Heading **Cancellation terms**; settled CTA **Free nights (no clawback)**. Cancel busy **Freeing nights…**. Cancel fail **Could not free these nights** (not “Could not free nights”). Confirm prompt ends **Free these nights?** (not “Continue?”). If Ready X already charged you, wait for **Recording Book & pay…** — do not Book & pay twice; open **My stays** (not “Recording stay…”). Quote fail **Could not quote Book & pay**. Confirm fallback **Could not record this Book & pay stay**. Recording: **Book & pay landed on-chain** (not “Payment landed”). Stay split **Paid who publishes this place at Book & pay** (not “Host paid at Book & pay”). Stay connector row **Connector % of stay** (not “Connector reward”). Stay CTAs **Messages** / **Places to Book & pay** (not “Message host”). Stay helper **Open Places to Book & pay to see more** (not “Open their profile”). Stay badge **Publishes this place** / **Book & pay** (not “Host” / “Guest”). Private helper **Shield the Book & pay asset on Ready X first** (not “on Profile”). Signing needs a live **Ready X** session |
| `/connector` | **Earn as connector** — intro **Friends publish places privately** (not “Friends list places”). Intro **When you share a place invite** (not “introduce a guest”). Example **950 DAI to who publishes this place** (not “host 950 DAI”). Explain model, share friend places, reward history. Section **Share place invite & earn** (not “Share & earn”). Subtitle **Share your place invite**. Step 1 **Friends to Book & pay** (not “people you already trust”). Rewards heading **Rewards from Book & pay** (not “Your rewards”). Rewards subtitle: paid when they **Book & pay through your place invite**. Totals **Across Book & pay through your place invites** (not “Across settled introductions”). Totals heading **Total from Book & pay** (not “Total earned”). Reward row **View stay** (not “open stay”); **You earned** (not “Reward:”). Rewards loader **Loading rewards from Book & pay…**. 0% empty **Friends to Book & pay have places** (not “Your friends have places”). 0% list **Also among friends to Book & pay (0% connector of stay)** (not “0% connector reward” / “Also in your network”). Host line **Publishes this place: {name}** (not “Host {name}”). 0% empty: **Ask them to set a %** when they **publish a place** (not “ask hosts”). Empty places **Add by Ready X wallet who publish a place** (not “Add friends by Ready X wallet”). No places CTA **Friends to Book & pay** (not “Add friends”) |

Shell nav: Home, Friends, Messages, List your place, Bookings, Earnings (`/connector`). Mobile **Open Philoxenia menu** / **Close Philoxenia menu** (not “Open menu” / “Close menu”). Overlay **Close Philoxenia menu overlay**. Notification bell heading **Friends, notes & stays** (not “Notifications”). Notification bell footer: Friends, Messages, Bookings, **Earnings**. Signed-out header CTA is **Connect Ready X** (same as landing). Missing mobile connector: **Ready X is not available. Chrome with the Ready X wallet extension is recommended, or download the Ready X wallet app.** (not “Use Chrome or the Ready X app.”). Sign-in without a session: **Ready X is not connected. Tap Connect Ready X.** Expired challenge: **Sign-in expired. Connect Ready X again.** JWT miss: **Connect Ready X to continue.** iPhone modal: **Copy Philoxenia link for Ready X.** Store CTA **Download Ready X wallet app** (not “Get Ready X”). Helper **open Philoxenia in the Ready X browser** (not “Prefer the in-app browser”). Missing Ready X: **Chrome with the Ready X wallet extension is recommended**, or **download the Ready X wallet app and open Philoxenia in the Ready X browser** (not “Smart Wallet + Private” / “app browser on iPhone”). Header/nav always `max-w-6xl`; page content may be `max-w-4xl` or `max-w-6xl` (`wide`). Client error boundary (`error.tsx`): heading **Philoxenia couldn’t load this page**; retry **Try Philoxenia again** (not “Try again”); body **Try Philoxenia again** (not “Try again”); **Disconnect Ready X & go Home** (not “Clear session & Connect Ready X”); **Connect Ready X to Book & pay** if the session is stuck; **Back to Home** is `/home` (not the landing). Home loaders: **Loading places to Book & pay…**. Host section title **My places**. Stay list title **My stays** (nav stays **Bookings**).
