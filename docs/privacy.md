...
- Prefer Private when Ready supports wallet API ≥ 0.10 (Chrome + Ready X, or Ready X in-app browser on iPhone). Profile’s shield checklist says so when the session is not privacy-capable.
