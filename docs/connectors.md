...
5. Guest opens the link → attribution is saved (last link wins). They become friends with **who publishes this place** if needed, then **Book & pay**. Earnings (`/connector`) step 3 is **They Book & pay**.
...
| Surface | What you do |
|---------|-------------|
| **`/connector` (Earnings)** | Explains the model, lists **friends’ places** with your earn %, one-tap share, reward history. Native share text: **Book & pay stay at … — open this place invite (STRK or DAI)**. Reward rows open `/bookings/:id` (**View stay**, not “open stay”; missing title **Book & pay stay**). Totals heading **Total from Book & pay** (not “Total earned”). Row **You earned** (not “Reward:”). Totals: **Across Book & pay through your place invites** (not “Across settled introductions”); asset shown **per stay**. Section **Share place invite & earn** (not “Share & earn”). Step 1: **Pick a friend’s place** — **Friends to Book & pay** (not “people you already trust”). Step 2: **Share your place invite** (not the Ready X wallet; **Opening the place invite** attributes you). How-to heading **How you earn when they Book & pay** (not “How you make money”). Intro **Friends publish places privately** (not “Friends list places”). Intro **When you share a place invite** (not “introduce a guest”). Empty places **Add by Ready X wallet who publish a place** (not “Add friends by Ready X wallet”). Host line **Publishes this place: {name}** (not “Host {name}”). Earn line **You earn {n}% connector of stay** (not “connector reward”) if they Book & pay. Native share button **Share place invite…** (not “Share via…”). 0% list: **Also among friends to Book & pay (0% connector of stay — a place invite won’t earn)** (not “0% connector reward” / “Also in your network”). 0% empty: **Friends to Book & pay have places** (not “Your friends have places”); **none offer a connector % of stay yet** (not “connector reward”). Empty places: add friends by **Ready X wallet** who **publish a place** (not “who host”) — **share a place invite and earn**. Empty CTA **Friends to Book & pay** (not “Add friends”). Empty rewards: share a friend’s **place** — they **Book & pay through your place invite**. 0% empty: set a % when they **publish a place** — you earn when they **Book & pay through your place invite**. Rewards heading: **Rewards from Book & pay** (not “Your rewards”). Rewards subtitle: paid to your **Ready X wallet** when they **Book & pay through your place invite**. Share place invite & earn subtitle: **Share your place invite** so they **Book & pay**. Loading: **Loading places to Book & pay…**. Rewards loading: **Loading rewards from Book & pay…** |
| **`/friends/[id]`** | Friend’s places + share; heading **Places to Book & pay**; intro **Places to Book & pay** (not “Places they host in your trust network”); **share a place invite** (not “share an invite”); CTA **Messages** (not Message) + **Earn as a connector** → `/connector`; empty: **open Messages**; **Share place invite & earn** (else **Share this place**); earn **You earn {n}% connector of stay** (not “connector reward”); 0% **No connector % of stay**; **View place**. Back **Back to Friends to Book & pay** (not “Back to friends”). `/friends` list CTA is also **Messages** (not Message). Loading: **Loading places to Book & pay…**. Load fail **Could not load places to Book & pay** (not “this friend’s places”). Not friends: **Not friends with this person — you must be friends to Book & pay their places** (not “this user”). Missing person: **they must Connect Ready X once**. Open from name or **Ready X wallet** on Friends / Messages. Opening your own places: **Open your own places from Home or My places.** (not “Opening your own profile”). |
| **`/friends`** | Tap friend’s **name** or **wallet** → their places |
| **`/messages`**, **`/messages/[friendId]`** | Same: name / wallet → **places**; preview / › → chat. **Share place invite** in the thread: pick a friend’s place (or your own), send a card; recipient **Open to Book & pay**. Connector attribution is recorded **when you send** the place invite in Messages (last-touch). |
...
|--------|------|------|-------------|
| GET | `/connector/earnings` | Yes | **Total from Book & pay** + stays where you were connector |
...
- Last invite the guest opened for that listing wins attribution — **or** the place invite you send them in Messages (attribution on send).
