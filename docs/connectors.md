...
3. Tap **Share place invite & earn** — creates an opaque `/invite/{token}` link with **you** as connector. The button shows **Copied!** when the clipboard succeeds (**Copy place invite**).
