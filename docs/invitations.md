...
4. Display name is cosmetic; rewards always go to the connector **Ready X wallet**. Unsigned guests tap **Connect Ready X to Book & pay** on `/invite/[token]`. Connector badge: **Connector (Ready X payout)**. Invite body: friends with **who publishes this place** to **Book & pay (STRK or DAI)** (not “friends with the host”); if they **Book & pay** through the place invite, the reward goes to the connector’s Ready X wallet.
