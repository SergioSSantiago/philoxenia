...
| `src/lib/json-ld.ts` | JSON-LD Organization + WebSite + SoftwareApplication (feature list: **Publish places**; **Book & pay** STRK or DAI — not “Guest Book & pay”; **Share a place invite and earn on Book & pay** — not “Connector introductions that earn on settle”; 0% on direct Book & pay) |
