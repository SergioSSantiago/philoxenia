        ...
        {networkListings === null ? (
          ...
          <div className="space-y-4">
            ...
            {earnable.length === 0 && noReward.length > 0 && (
              <EmptyState message="Your friends have places, but none offer a connector reward yet (0%). Ask them to set a % when they list a place — you earn when they Book & pay through your place invite." />
            )}
