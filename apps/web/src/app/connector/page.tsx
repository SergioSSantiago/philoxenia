    ...
    <Shell>
      ...
      <Card className="mb-10 space-y-4 border-accent/20 bg-accent-soft/30">
        ...
        <ol className="space-y-3 text-sm leading-relaxed text-foreground">
          ...
          <li>
            ...
            {" — "}
            not the Ready X wallet. Opening the place invite attributes you as
            connector.
          </li>
          <li>
      ...
      <section className="mb-12">
        ...
        {networkListings === null ? (
          ...
          <EmptyState message="No friend places yet. Add friends by Ready X wallet who host — their places show up here so you can share a place invite and earn when they Book & pay." />
        ) : (
          <div className="space-y-4">
            ...
            {earnable.length === 0 && noReward.length > 0 && (
              <EmptyState message="Your friends have places, but none offer a connector reward yet (0%). Ask them to set a % when they publish a place — you earn when they Book & pay through your place invite." />
            )}
