...
export default function FriendProfilePage() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then(setProfile)
      .catch((err) => {
        setError(err instanceof Error ? err.message : "Could not load places to Book & pay");
      });
      ...
      <Card className="mb-8 space-y-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Places to Book & pay — open one, or share a place invite to earn as
            connector (STRK or DAI, same asset they Book &amp; pay).
          </p>
        </div>
