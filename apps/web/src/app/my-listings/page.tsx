...
export default function MyListingsPage() {
  ...
  return (
    <Shell wide>
      ...
      {listings.length === 0 ? (
        <EmptyState message="You haven’t published a place yet. Friends only see what you publish — add nights and a connector % so they can share a place invite and earn when they Book & pay." />
      ) : (
