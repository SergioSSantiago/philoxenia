...
export const SITE_DESCRIPTION =
  "Private peer-to-peer hospitality on Starknet. Hosts list for friends, guests book privately, and connectors earn by introducing trusted people — no public marketplace.";
