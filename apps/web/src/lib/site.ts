...
export const SITE_DESCRIPTION =
  "Private peer-to-peer hospitality on Starknet. Hosts publish places for friends, guests Book & pay STRK or DAI, and connectors earn by introducing trusted people — no public marketplace.";
