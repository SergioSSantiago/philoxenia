...
<strong>iPhone:</strong> Safari can <strong>login</strong> via WalletConnect. For <strong>Private STRK or DAI</strong>, open Philoxenia in the Ready X in-app browser.<br/>
